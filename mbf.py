...
%s -(           I      I  %s@@%s\\
   ...
   [ MULTI BRUTEFORCE FACEBOOK NO LOOGIN ]
     ...
     [01] Crack from email user#2568FF
     [02] Crack from id user#FF006C
     [03] Dump all id facebook user
     [04] Dump all email facebook user#C900FF
     [00] exit program
""" % (col(97), col(91),
